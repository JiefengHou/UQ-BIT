<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search Person’s Job.aspx.cs" Inherits="WebApplication1.Search_Person_s_Job" %>
...
<body>
    ...
    <div id="title">
        <h3>Search Person’s Job Page:</h3>
    </div>

    <form id="form1" runat="server">
    <div>
    
        <asp:Label ID="Label1" runat="server" Text="Search Person’s Job"></asp:Label>
        <br />
        <br />
