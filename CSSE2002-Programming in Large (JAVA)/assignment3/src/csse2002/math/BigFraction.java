...
public class BigFraction implements Comparable<BigFraction> {
	...
	// WARNING: not in A1 handout
	
	/**
	 * Returns this BigFraction as a double. (If the magnitude either the
	 * numerator or denominator is too big to be represented as a double, this
